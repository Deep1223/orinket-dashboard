...
const TextareaRenderField = (props) => {
  ...
  return (
    <div className={`${props.field.size} mb-3`}>
      ...
      <ValueContainer className="align-items-start">
        <span className="text-14 fw-semibold text-dark text-break py-1">
...
export default TextareaRenderField;
