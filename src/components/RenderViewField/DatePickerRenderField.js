...
const DatePickerRenderField = (props) => {
  ...
  return (
    <div className={`${props.field.size} mb-3`}>
      ...
      <ValueContainer>
        <span className="text-14 fw-semibold text-dark">
          {props.viewDetails[props.field.field]
            ? IISMethods.getDateFormate(props.viewDetails[props.field.field])
            : '-'}
        </span>
      </ValueContainer>
    </div>
...
export default DatePickerRenderField;
